    ...
    const result = await pool.query(
      `UPDATE cars
       SET brand = $1, model = $2, year = $3, price = $4, mileage = $5,
           body_type = $6, description = $7, status = $8, engine_volume = $9,
           fuel_type = $10, power = $11, transmission_type = $12, drive_type = $13
       WHERE id = $14
       RETURNING *`,
      [brand, model, year, price, mileage, body_type, description, status, 
       engine_volume, fuel_type, power, transmission_type, drive_type, carId]
    );
